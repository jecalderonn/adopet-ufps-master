...
interface IRedsocialDao {
  ...
  public function select($redsocial);
    /**
     * Lista todos los objetos Redsocial en la base de datos.
     * @return Array<Redsocial> Puede contener los objetos consultados o estar vacío
     * @throws NullPointerException Si los objetos correspondientes a las llaves foraneas son null
     */
