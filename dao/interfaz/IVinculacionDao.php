...
interface IVinculacionDao {
  ...
  public function select($vinculacion);
    /**
     * Lista todos los objetos Vinculacion en la base de datos.
     * @return Array<Vinculacion> Puede contener los objetos consultados o estar vacío
     * @throws NullPointerException Si los objetos correspondientes a las llaves foraneas son null
     */
