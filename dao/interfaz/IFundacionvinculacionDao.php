...
interface IFundacionvinculacionDao {
  ...
  public function select($fundacionvinculacion);
    /**
     * Lista todos los objetos Fundacionvinculacion en la base de datos.
     * @return Array<Fundacionvinculacion> Puede contener los objetos consultados o estar vacío
     * @throws NullPointerException Si los objetos correspondientes a las llaves foraneas son null
     */
