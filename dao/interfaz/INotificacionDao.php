...
interface INotificacionDao {
  ...
  public function select($notificacion);
    /**
     * Lista todos los objetos Notificacion en la base de datos.
     * @return Array<Notificacion> Puede contener los objetos consultados o estar vacío
     * @throws NullPointerException Si los objetos correspondientes a las llaves foraneas son null
     */
