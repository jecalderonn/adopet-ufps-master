...
$respuesta = 0;
if ($fechaHistorialMascota === "" || $descripcion === "" || $Observacion === "" || $Mascota_idMascota === "") {
    echo $respuesta;
} else {
    $respuesta = HistorialmascotaFacade::insert($fechaHistorialMascota, $descripcion, $Observacion, $mascota);
    if ($respuesta > 0) {
