...
$idAlbergue = strip_tags($dataObject->idAlbergue);
...
$respuesta = 0;
if ($idAlbergue === '' || $nombreAlbergue === '' || $telefonoAlbergue === '' || $direccionAlbergue === '' || $idFundacion === '') {
    echo $respuesta;
} else {
    $respuesta = AlbergueFacade::update($idAlbergue,$nombreAlbergue, $telefonoAlbergue, $direccionAlbergue, $fundacion);
    if ($respuesta > 0) {
